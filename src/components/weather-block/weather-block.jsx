...
const WEATHER_API_KEY = process.env.REACT_APP_OPENWEATHER_API_KEY || "acd4f346c669d7400f4dbbeb7f1350e0";
  ...
  useEffect(() => {
    ...
    const fetchWeather = async (cityName) => {
      try {
        ...
        console.warn("Weather fetch failed, trying default city:", err.message);
