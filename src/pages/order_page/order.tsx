...
const ADVANTAGES = [
  {
    icon: FiClock,
    title: "Расчёт бесплатно за 30 минут",
    text: "Оценим стоимость по фото в течение 30 минут",
  },
  {
    icon: FiShield,
    title: "Гарантия 1 год на все работы",
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Стоимость зависит от характера повреждения и модели лодки. Пришлите фото повреждения через форму заявки — мы бесплатно рассчитаем стоимость в течение 30 минут.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, мы предоставляем официальную гарантию 1 год на все виды ремонта. Если проблема повторится — устраним её бесплатно.",
  },
  {
    question: "Можно ли отремонтировать лодку без визита в мастерскую?",
    answer:
      "Да, при необходимости наш специалист может выполнить ремонт на месте стоянки лодки. Уточните это при оформлении заявки.",
  },
  {
